...
INSERT INTO tracklist(song_id, album_id) VALUES (1, 1);
INSERT INTO tracklist(song_id, album_id) VALUES (2, 1);
INSERT INTO tracklist(song_id, album_id) VALUES (1, 2);
INSERT INTO tracklist(song_id, album_id) VALUES (2, 2);

CREATE INDEX song_index ON tracklist(song_id);

EXPLAIN QUERY PLAN SELECT * FROM tracklist WHERE id = 1;
EXPLAIN QUERY PLAN SELECT * FROM tracklist WHERE  song_id = 1;
